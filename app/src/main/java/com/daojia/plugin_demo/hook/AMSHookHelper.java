...
import com.daojia.plugin_demo.intercept_activity.ActivityThreadHandlerCallback;
...
public class AMSHookHelper {
    ...
    public static void hookActivityManagerNative() throws ClassNotFoundException,
        ...
        Object proxy = Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(),
                rawIActivityManager.getClass().getInterfaces(), new IActivityManagerHandler(rawIActivityManager));
